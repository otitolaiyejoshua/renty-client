...
function AgentSettings() {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            ...
            try {
                const res = await axios.get(`https://renty-server.onrender.com/api/agentSettings/${agentId}`, {
                    headers: {
    ...
    const handleProfileUpdate = async (e) => {
        ...
        try {
            const res = await axios.put(`https://renty-server.onrender.com/api/agentSettings/profile`, formData, {
                headers: {
                    'Authorization': `Bearer ${token}`,
    ...
    const handlePasswordChange = async (e) => {
        ...
        try {
            const res = await axios.put(`https://renty-server.onrender.com/api/agentSettings/password`, {
